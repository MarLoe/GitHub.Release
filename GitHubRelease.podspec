#
#  Be sure to run `pod spec lint GitHubRelease.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/MarLoe/GitHub.Release"
  ...
  s.author       = "Martin Løbger"
  s.social_media_url   = "https://github.com/MarLoe"
  ...
  s.source_files  = "GitHubRelease", "GitHubRelease/**/*.{h,m}"
  # s.exclude_files = "GitHubRelease/Exclude"

  # s.public_header_files = "GitHubRelease/**/*.h"
